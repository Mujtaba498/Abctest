  ...
  return (
    <Card className="w-[90%] mx-auto">
      ...
      <CardContent className="max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleCreate} className="flex gap-2 mb-4 items-center">
        ...
        {selectedTags.length > 0 && (
          <div className="flex items-center justify-between p-4 bg-blue-50 border border-blue-200 rounded-md mb-4">
